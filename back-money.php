...
<body>
    ...
    <div class="wrap">
        <div class="card" style="margin-top:5%;">
            <h3 class="card-header"><i class="fa fa-bitcoin"></i> 儲值</h3>
            <div class="card-body">
                <h5 class="card-title">DEPOSIT</h5>
                <p class="card-text">好好想想，你不儲值，怎麼能變的更強呢?</p><br>
                <form action="part/updatemoney.php" method="post">
                    <div class="input-group input-group-lg">
                        <span class="input-group-text">NTD</span>
                        <input type="number" name="money" class="form-control" placeholder="能儲一個億是最好的" aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <button class="btn btn-success" type="submit">儲值</button>
                    </div>
                </form>
                <br>
                <hr>
